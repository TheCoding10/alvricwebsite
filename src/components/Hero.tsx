    ...
    <section className="relative min-h-[90vh] overflow-hidden bg-slate-950 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="hero-content max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-3 gap-6 sm:gap-8 max-w-2xl mx-auto">
          <div className="group p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-500/30 backdrop-blur-md transition-all hover:bg-white/10">
          ...
          <div className="group p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 hover:border-pink-500/30 backdrop-blur-md transition-all hover:bg-white/10">
            <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent mb-2">
              20+
            </div>
